...
import { FaCcApplePay, FaCcPaypal, FaCcVisa, FaFacebook, FaInstagram, FaTwitter } from 'react-icons/fa';
...
export default function Footer() {
  ...
  <div className="flex items-center space-x-4 mt-2">
    <FaCcVisa className="text-6xl text-blue-600 bg-white p-2" title="Visa" />
    <FaCcPaypal className="text-6xl text-blue-800 bg-white p-2" title="PayPal" />
    <FaCcApplePay className="text-6xl text-black bg-white p-2" title="Apple Pay" />
  </div>
</div>
          </div>
        </div>
        ...
        <div className="mt-8 border-t-2 pt-4 border-[#D9D9D9] flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <Link href="#" className="bg-black text-white rounded-full p-2">
            ...
            <Link href="#" className="bg-black text-white rounded-full p-2">
              <FaInstagram className="lg:text-3xl" />
            </Link>
          </div>
        </div>
      </div>

        ...
        <div className="flex lg:flex-row flex-col">
          ...
          <div className="flex-1 lg:grid lg:grid-cols-3 flex justify-between gap-2">
            ...
            <div className="space-y-2 text-[#212337] ">
              <h3 className="font-semibold lg:text-lg text-sm  flex-1">
                Quick links 1
              </h3>
              <Link
                href="#"
                className="block hover:underline lg:text-base text-sm"
              >
                Home
              </Link>
              <Link
            ...
            <div className="space-y-2 text-[#212337]  flex-1">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="lg:text-base text-sm">1234 567 890</span>
              </div>
              <div className="flex items-center space-x-2">
                <MdMailOutline className="h-5 w-5 text-[#759c40]" />
                <span className=" lg:text-base text-sm flex  justify-center items-center flex-wrap ">
                  Freshharvests@gmail.com
                </span>
              </div>
              <div className="flex items-center space-x-2">
                <MdLocationOn className="lg:h-8 lg:w-6 h-6 w-8 text-[#759c40]" />
                <span className="lg:text-base text-sm ">
                  Tarung Sori Street, Pontianak, Indonesia
                </span>
              </div>
            ...
            {/* for small device responsive need these two section again */}
